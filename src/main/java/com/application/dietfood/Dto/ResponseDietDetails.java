...
public class ResponseDietDetails {
	...
	public ResponseDietDetails() {
		
	}

	public ResponseDietDetails(String name, String type, Double calories, Double protein, Double carbohydrates, Double fat,
			Double fiber, Double sugar, Double salt, Double cholesterol, Double calcium, Double iron, Double potassium,
